...
var planetFactory = {
  ...
  createPlanet : function(options) {
    ...
    chosen_tileset = (parentId == 'null') ? this._pickPlanetTileset() : this._pickMoonTileset();
    var planet = {
      id : this._initId(parentId),
      group : 'planets',
      tileset : chosen_tileset,
      colh: gbox.getTiles(chosen_tileset).tileh,
      ...
      first: function() {
        if (this.parentPlanet != 'null') {
          ...
          var parentPoint = {
            x : this.parentPlanet.x + this.parentPlanet.hw - 15,
            y : this.parentPlanet.y + this.parentPlanet.hh - 15
          };
          // console.log(this.parentPlanet.x);
          // console.log(this.parentPlanet.hw);
